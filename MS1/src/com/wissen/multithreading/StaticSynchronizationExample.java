 ...
 * 
 * Remember that static synchronization should be used judiciously, as excessive 
 * synchronization can lead to performance bottlenecks. Choose the appropriate level of 
 * synchronization based on your application’s requirements!
 */
class Display {
