...
public class EmployeeProblemsPractice {
	...
	public static void main(String[] args) {
		...
		List<Employee> collect7 = list.stream()
		...
		Employee highestSalPaidEmp = list.stream().max((e1, e2) -> e1.salary - e2.salary).orElse(null);
		System.out.println(highestSalPaidEmp);
		System.out.println("------------------------------");
		
		System.out.println("10. Total number of males & females");
		Map<String, List<Employee>> collect8 = list.stream().collect(Collectors.groupingBy(e -> e.gender));
